        ...
        parsed: function (columns) {
            ...
            for (var movie in movieInfo) {
                for (var count = 0; count < 5; count++) {
                    if (countryMovieData[movieInfo[movie].index][count].name !== 'Canada') {
